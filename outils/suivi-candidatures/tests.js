/* ==========================================================================
   Suivi de candidatures — tests
   Lanceur minimal, sans dépendance ni build : ouvrir tests.html.
   Chaque test décrit un comportement attendu de logique.js.
   ========================================================================== */
...
(function () {
  ...
  function test(nom, fn) {
    try {
      fn();
      resultats.push({ nom: nom, ok: true });
    } catch (e) {
      resultats.push({ nom: nom, ok: false, message: e.message });
    }
  }
